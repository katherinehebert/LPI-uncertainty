...
pal_lags <- c("#3f007d", "#6a51a3", "#9e9ac8")
...
a <- df_sc1 %>%
  ...
  summarise(mean_se(accuracy_boot)) %>%
...
ggplot(aes(col = Process_error, y = y, x = direction)) +
 ...
 theme(legend.position = "bottom") +
  scale_color_manual(values = pal_error)
a + b
ggsave("~/Documents/GitHub/LPI-sensitivity/figures/figsupp_covariance.png", width = 7.6, height = 6)
```
