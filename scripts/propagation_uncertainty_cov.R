...
# render
# rmarkdown::render("propagation_uncertainty_cov.R", output_format = "pdf_document", output_file = "propagation_uncertainty_cov_decline")
# rmarkdown::render("propagation_uncertainty_cov.R", output_format = "pdf_document", output_file = "propagation_uncertainty_cov_stable")
# rmarkdown::render("propagation_uncertainty_cov.R", output_format = "pdf_document", output_file = "propagation_uncertainty_cov_increase")
